...
impl<Application: ApplicationLayer> Context<Application> {
    ...
    pub fn open(
        ...
        mut mtu: usize,
        remote_static_key: Application::PublicKey,
        application_data: Application::SessionData,
        local_identity_blob: Application::LocalIdentityBlob,
        current_time: i64,
    ) -> Result<Arc<Session<Application>>, OpenError<Application::StorageError>> {
        mtu = mtu.max(MIN_TRANSPORT_MTU);
    ...
    pub fn receive<'a, SendFn: FnMut(&mut [u8]) -> bool>(
        ...
        check_accept_session: impl FnOnce(&Application::PublicKey, &[u8], u64) -> (Option<(bool, Application::SessionData)>, bool),
        ...
        current_time: i64,
    ) -> Result<ReceiveResult<'a, Application>, ReceiveError<Application::StorageError>> {
...
impl<Application: ApplicationLayer> NoiseXKAliceHandshake<Application> {
    ...
    fn initialize(
        ...
        OpenError<Application::StorageError>,
    > {
...
fn assemble_fragments_into<A: ApplicationLayer>(fragments: &[A::IncomingPacketBuffer], d: &mut [u8]) -> Result<usize, ReceiveError<A::StorageError>> {
    let mut l = 0;
